...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="relative min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="mb-20 text-3xl font-bold text-center dark:text-white text-neutral-800"
      >
        {title || (
          <span>
      ...
      <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        {showGradient && (
          <div className="absolute inset-x-0 bottom-0 z-50 w-full h-40 bg-gradient-to-t dark:from-black from-white via-white dark:via-black to-transparent"></div>
        )}
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img
          ...
          alt="aceternity logo"
          loading="lazy"
          className="absolute inset-0 object-cover object-left-top w-full h-full rounded-lg"
        />
      </motion.div>
    </div>
  );
